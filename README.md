...
### 📱 Mobile Projects
- **[QuizzApp](https://github.com/fhira21/QuizzApp)**  
  Mobile app for interactive quizzes with modern UI.

### 🌐 Web Applications
- **[Manajemen Bengkel Online](https://github.com/fhira21/Manajemen_Bengkel_Online)**  
  Complete workshop management system (booking, service, sparepart).  

- **[fe_bytelogic](https://github.com/fhira21/fe_bytelogic)**  
  Frontend for employee performance evaluation system using modern UI components.

- **[be_bytelogic](https://github.com/fhira21/be_bytelogic)**  
  Backend REST API for performance evaluation system (Express + MySQL).  
...
<p align="center">✨ <i>“Code, Learn, and Grow Every Day.”</i> ✨</p>
